...
const audioSources = [
  {
    src: '@initParams.audioA',
    id: 'id1',
    classes: ['class1', 'class2', 'class3'],
    base64: true,
  },
  {
    src: '@initParams.audioB',
    id: 'id2',
    classes: ['class1', 'class2', 'class3'],
    base64: true,
  },
...
test('Check @initParams support on audioSources', () => {
  ...
  const res = rootClip.resolveAudioSources(audioSources);
  expect(res).toEqual([
    {
      src: sound,
      id: 'id1',
  ...
  const dc = new DescriptiveIncident(
    {
      animatedAttrs: { value: 3 },
    },
    {
      selector: '.a',
      duration: 2000,
