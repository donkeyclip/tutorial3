...
class Group extends Node {
  constructor(attrs, props) {
    ...
    _defineProperty(this, "handleRemoveIncident", this.handleMoveIncident);

    _defineProperty(this, "setBlock", block.bind(this));

    _defineProperty(this, "unblock", unblock.bind(this));
...
class MonoIncident {
  constructor() {
    ...
    _defineProperty(this, "getIncidentsByChannel", getIncidentsByChannel.bind(this));
...
_defineProperty(DescriptiveGroup, "Incident", Group);

_defineProperty(DescriptiveGroup, "plugin_npm_name", _MC_Plugin_Name);

_defineProperty(DescriptiveGroup, "version", version);

_defineProperty(DescriptiveGroup, "Channel", Channel);

_defineProperty(DescriptiveGroup, "ClassName", 'Group');

_defineProperty(DescriptiveGroup, "isGroup", true);

_defineProperty(DescriptiveGroup, "attrsValidationRules", null);

_defineProperty(DescriptiveGroup, "propsValidationRules", groupPropsRule);
...
_defineProperty(HTMLDescriptiveClip, "isClip", true);

_defineProperty(HTMLDescriptiveClip, "Incident", BrowserClip);

_defineProperty(HTMLDescriptiveClip, "plugin_npm_name", '@donkeyclip/self-contained-incidents');

_defineProperty(HTMLDescriptiveClip, "version", version);

_defineProperty(HTMLDescriptiveClip, "Channel", ClipChannel);

_defineProperty(HTMLDescriptiveClip, "ClassName", 'HTMLClip');

_defineProperty(HTMLDescriptiveClip, "propsValidationRules", clipPropsRule);
...
_defineProperty(AttributeChannel, "type", 'attributes');
...
_defineProperty(DescriptiveIncident, "Incident", MonoIncident);

_defineProperty(DescriptiveIncident, "plugin_npm_name", _MC_Attribute);

_defineProperty(DescriptiveIncident, "version", version);

_defineProperty(DescriptiveIncident, "Channel", AttributeChannel);

_defineProperty(DescriptiveIncident, "ClassName", 'Incident');

_defineProperty(DescriptiveIncident, "attrsValidationRules", null);

_defineProperty(DescriptiveIncident, "propsValidationRules", incidentPropsRule);
...
function loadPlugin(plugin) {
  ...
  if (hasOwnProp(plugin, 'Clip')) {
    if (!hasOwnProp(plugin.Clip, 'exportable')) {
      ...
      const DynamicDescriptiveClip = (_class = class DynamicDescriptiveClip extends HTMLDescriptiveClip {}, _defineProperty(_class, "Incident", plugin.Clip), _defineProperty(_class, "plugin", plugin.npm_name), _defineProperty(_class, "version", plugin.version || '*'), _defineProperty(_class, "audio", plugin.audio || 'off'), _defineProperty(_class, "customClip", true), _class);
      ...
      const DynamicDescriptiveClip = (_class2 = class DynamicDescriptiveClip extends HTMLDescriptiveClip {}, _defineProperty(_class2, "Incident", plugin.Clip.exportable), _defineProperty(_class2, "plugin", plugin.npm_name), _defineProperty(_class2, "version", plugin.version || '*'), _defineProperty(_class2, "audio", plugin.audio || 'off'), _defineProperty(_class2, "customClip", true), _class2);
...
function prepareIncident(plugin, i, AttributeChannelToUse) {
  ...
  if (incidentClass.prototype instanceof MonoIncident) {
    ...
    DynamicDescriptiveIncident = (_class3 = class DynamicDescriptiveIncident extends DescriptiveIncident {}, _defineProperty(_class3, "Incident", incidentClass), _defineProperty(_class3, "plugin_npm_name", plugin.npm_name), _defineProperty(_class3, "plugin", plugin.npm_name), _defineProperty(_class3, "version", plugin.version || '*'), _defineProperty(_class3, "ClassName", plugin.incidents[i].name), _defineProperty(_class3, "Channel", AttributeChannelToUse), _defineProperty(_class3, "audio", plugin.audio || 'off'), _class3);
  } else if (incidentClass.prototype instanceof MediaPlay) {
    var _class4;

    DynamicDescriptiveIncident = (_class4 = class DynamicDescriptiveIncident extends DescriptiveIncident {}, _defineProperty(_class4, "Incident", incidentClass), _defineProperty(_class4, "audio", plugin.audio || 'off'), _defineProperty(_class4, "plugin_npm_name", '@donkeyclip/media-playback'), _defineProperty(_class4, "plugin", plugin.npm_name), _defineProperty(_class4, "version", plugin.version || '*'), _defineProperty(_class4, "ClassName", plugin.incidents[i].name), _defineProperty(_class4, "Channel", AudioPlaybackChannel), _class4);
  } else if (incidentClass.prototype instanceof HTMLDescriptiveClip) {
    var _class5;

    DynamicDescriptiveIncident = (_class5 = class DynamicDescriptiveIncident extends incidentClass {}, _defineProperty(_class5, "audio", plugin.audio || 'on'), _defineProperty(_class5, "originalDims", originalDimsCheck(plugin.incidents[i].originalDims).analysis), _defineProperty(_class5, "isAnimation", true), _class5);
  ...
  return {
    ...
    get() {
      ...
      _defineProperty(WrapperClass, "targetClass", DynamicDescriptiveIncident);
...
_defineProperty(CSSEffect, "targetClass", CSSLayer.CSSEffect.targetClass);
...
class DescriptiveCombo extends DescriptiveGroup {
  constructor(attrs, props) {
    ...
    _defineProperty(this, "addIncident", handleInvalidIncidentChange);

    _defineProperty(this, "moveIncident", handleInvalidIncidentChange);

    _defineProperty(this, "removeIncident", handleInvalidIncidentChange);

    _defineProperty(this, "handleCheckAddition", alwaysReturnFalse);

    _defineProperty(this, "handleCheckMove", alwaysReturnFalse);

    _defineProperty(this, "handleCheckDeletion", alwaysReturnFalse);

    _defineProperty(this, "handleCheckResize", alwaysReturnFalse);
...
_defineProperty(DescriptiveCombo, "isCombo", true);

_defineProperty(DescriptiveCombo, "ClassName", 'Combo');

_defineProperty(DescriptiveCombo, "attrsValidationRules", null);

_defineProperty(DescriptiveCombo, "propsValidationRules", comboPropsRule);
...
export { DescriptiveAudioClip as AudioClip, AudioEffect, AudioPlayback, BrowserClip, CSSEffect, DescriptiveCombo as Combo, CoreAudioClip, MonoIncident as Effect, ExtendableCSSEffect, DescriptiveGroup as Group, HTMLDescriptiveClip as HTMLClip, MediaPlay as MediaPlayback, TimeCapsule, loadPlugin, setCore as setCSSCore, utils, version };
